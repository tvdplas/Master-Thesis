...
Next, let us consider the E-VCSP.  \todo{dsafds} et us consider two main things: the number of normal rounds that we perform, and the number of rounds with disrupted lambda that we perform afterwards. 
...
We also see that the number of new generated columns per round decreases over time. \todo{wat wil ik hier nog zeggen} \\
