...
A collection of instances was also provided by Qbuzz. A summary of each of these instances was provided in Table \ref{tab:instances}. We will now discuss each of these instances in more detail, along with any modifications required in order to turn the instances into feasible input for our algorithms. 
...
In real life, crew duties in this instance are allowed to walk between the depot and the central train station; this is used in order to allow easier signing on and off of crew members, as there are no trips which have the depot as an endpoint. As we do not allow for crew movements without the use of a vehicle in our algorithm, we modified the instance by turning the central station into a crew hub as well; sign-on and off times for the central station incorporate the 6-minute walking time, thereby modeling a crew member signing on at the depot and then directly walking to their vehicle at the central station. 
...
\begin{table}[h]
  ...
  \begin{tabular}{llrrrrrr}
    ...
    \addlinespace[0.4em]
    & \textbf{value}  & 3621.8 & 3397.5 & 3383.7 & 3380.7 & 3395.8 & 3371.9 \\
    $M=4$ & \textbf{gap}   & 13.3 & 7.5 & 8.9 & 8.8 & 9.6 & 10 \\
    & \textbf{cols} & 3954 & 7858 & 8034 & 15871 & 18901 & 28007 \\
    \arrayrulecolor{black!30}\cmidrule(lr){1-8}
    & \textbf{value}  & 3621.8 & 3404.1 & 3383.7 & 3380.7 & 3395.8 & 3371.9 \\
    $M=8$ & \textbf{gap}   & 13.3 & 7.6 & 8.9 & 8.8 & 9.6 & 10 \\
    & \textbf{cols} & 3954 & 7858 & 8034 & 15871 & 18901 & 28007 \\
    \arrayrulecolor{black!30}\cmidrule(lr){1-8}
    & \textbf{value}  & 3621.8 & 3404.1 & 3383.7 & 3380.5 & 3395.8 & 3371.9 \\
    $M=12$ & \textbf{gap}   & 13.3 & 7.6 & 8.9 & 8.8 & 9.6 & 10 \\
    & \textbf{cols} & 3954 & 7858 & 8034 & 15871 & 18901 & 28007 \\
    \arrayrulecolor{black!30}\cmidrule(lr){1-8}
    & \textbf{value}  & 3621.8 & 3404.1 & 3383.7 & 3380.9 & 3395.8 & 3371.9 \\
    $M=16$ & \textbf{gap}   & 13.3 & 7.6 & 8.9 & 8.8 & 9.6 & 10 \\
    & \textbf{cols} & 3954 & 7858 & 8034 & 15871 & 18901 & 28007 \\
    \arrayrulecolor{black}\bottomrule
  \end{tabular}
  \caption{Effect of secondary columns on \texttt{leiden-1-2}.}
  \label{tab:evsp-secondary-columns}
\end{table}

As we can see, the number of columns we use as a base is more important than the number of ways we subdivide trips in order to block; only $N=2$ and 4 show slight variations in the objective value. Next, we see that we are generally able to find a better solution within the timelimit with higher $N$. We do however see that $N=8$ is worse than $N=2$ and 4; this is most likely caused by the number of columns causing Gurobi to make different choices in its solving strategy and heuristics. Based on this, we will use $N=16$ and $M=4$ for all vehicle labeling going forward. 
