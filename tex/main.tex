...
\begin{table}[h]
  ...
  \begin{tabular}{lcrrrrrcc}
    \toprule
       \textbf{Name} & \textbf{Lines} & $|\mathcal{T}|$ & $|\mathcal{L}_c|$ & $|\mathcal{L}_{rl}|$ & $|\mathcal{L}_{cb}|$ & Range & $cost_{VT,min}$ & $cost_{CR,min}$ \\
...
\begin{table}[h]
  ...
  \begin{tabular}{llccccccccc}
    \toprule
    \multicolumn{2}{c}{Blocking rounds} & $0$ & $1$ & $2$ & $3$ & $4$ & $5$ & $6$ & $7$ & $8$ \\
    \cmidrule(lr){1-2}\cmidrule(lr){3-11}
    & value  & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
    $divs=0$ & cols   & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
    & mipgap & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
    \addlinespace[0.4em]
    ...
    \bottomrule
  \end{tabular}
  \caption{Effect of secondary column parameter $n$ on solution quality for \texttt{leiden-1-2}. }
  \label{tab:secondary-columns}
\end{table}
