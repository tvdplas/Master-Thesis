  ...
  \begin{tikzpicture}
    \begin{groupplot}[
      ...
      \addplot+[only marks, mark=diamond*, mark size=1.8pt]
        coordinates {
          (6430.078772237068,22438.083333333332)
          (6370.052879846232,22105.000000000004)
          (6118.55114164412,21786.500000000007)
          (6383.714759074799,22067.833333333332)
          (6348.127006021544,21507.916666666668)
        };
    \end{groupplot}
  \end{tikzpicture}
...
As we can clearly see, overall solution quality can be greatly influenced by the initial vehicle solution. In the instance \texttt{terschelling} for instance, a 40 euro difference in vehicle costs can result in a 200 euro cost difference overall. In general, we do see that lower vehicle costs tend to imply lower overall costs; this can mostly be attributed to the fact that cheaper vehicle schedules generally also imply less driven hours, which can result in a decrease in the required number of crew working hours. We do however see outliers; in particular in the \texttt{leiden} instance, the largest in our testset. Here, a higher vehicle cost can be incurred in order to reduce overall costs, thereby showing the flaws of the sequential method oncemore. 
