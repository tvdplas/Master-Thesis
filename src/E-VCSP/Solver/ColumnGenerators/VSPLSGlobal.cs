...
//                    SoCAtStart = vehicleType.StartSoC,
//                    SoCAtEnd = vehicleType.StartSoC,
//                };
//                LLNode dh1 = depotStart.AddAfter(LLNodeType.Deadhead, new VEDeadhead(depotTripArc.Deadhead, StartTime, vehicleType));
//                LLNode idle1 = dh1.AddAfter(LLNodeType.Idle, new VEIdle(t.From, dh1.VE.EndTime, t.StartTime, vehicleType));
//                LLNode trip = idle1.AddAfter(LLNodeType.Trip, new PVETrip(t, vehicleType));
//                LLNode dh2 = trip.AddAfter(LLNodeType.Deadhead, new VEDeadhead(tripDepotArc.Deadhead, t.EndTime, vehicleType));
//                LLNode idle2 = dh2.AddAfter(LLNodeType.Idle, new VEIdle(Depot, dh2.VE.EndTime, EndTime, vehicleType));
//                LLNode depotEnd = idle2.AddAfter(LLNodeType.Depot, new PVEDepot(Depot, EndTime, EndTime + Config.MIN_NODE_TIME));
...
//            while (curr != null)
//            {
//                if (t1FirstAffected == null && (curr.NodeType == LLNodeType.Depot || curr.NodeType == LLNodeType.Trip) && curr.VE.StartTime >= time)
//                {
...
//            while (curr != null)
//            {
//                if (t2FirstAffected == null && (curr.NodeType == LLNodeType.Depot || curr.NodeType == LLNodeType.Trip) && curr.VE.StartTime >= time)
//                {
...
//                PVETrip? additionTargetAsTrip = additionTarget.NodeType == LLNodeType.Trip ? ((PVETrip)additionTarget.VE) : null;
//                int fromIndex = additionTargetAsTrip?.Trip.Index ?? instance.DepotStartIndex;
//                int toIndex = firstAffected.NodeType == LLNodeType.Trip
//                    ? ((PVETrip)firstAffected.VE).Trip.Index
...
//                    VE = ved,
//                };
//                LLNode idle = dh.AddAfter(LLNodeType.Idle, new VEIdle(ved.Deadhead.DeadheadTemplate.To, ved.EndTime, firstAffected.VE.StartTime, vehicleType));
...
//            PVETrip? t2PrevAsTrip = t2Prev.NodeType == LLNodeType.Trip ? (PVETrip)t2Prev.VE : null,
//                    t2NextAsTrip = t2Next.NodeType == LLNodeType.Trip ? (PVETrip)t2Next.VE : null;
...
//                    if (curr.VE.EndTime > t2Start.VE.StartTime) break;
//                    else t1Prev = curr;
//                }
//                curr = curr.Next;
//            }
...
//            PVETrip t2StartRangeAsTrip = (PVETrip)t2Start.VE,
//                   t2EndRangeAsTrip = (PVETrip)t2End.VE;
//            PVETrip? t1PrevAsTrip = t1Prev.NodeType == LLNodeType.Trip ? (PVETrip)t1Prev.VE : null,
//                    t1NextAsTrip = t1Next.NodeType == LLNodeType.Trip ? (PVETrip)t1Next.VE : null;
...
//            // New glue
//            // t1Prev -> t2Start
//            VEDeadhead vedNewDh2Start = new(t1PrevTot2Start.Deadhead, t1Prev.VE.EndTime, vehicleType);
...
//                VE = vedNewDh2Start,
//            };
//            LLNode newIdle2Start = newDh2Start.AddAfter(LLNodeType.Idle, new VEIdle(vedNewDh2Start.Deadhead.DeadheadTemplate.To, vedNewDh2Start.EndTime, t2Start.VE.StartTime, vehicleType));
//            newIdle2Start.Next = t2Start;
//            // t2End -> t1Next
//            VEDeadhead vedNewDh2End = new(t2EndTot1Next.Deadhead, t2End.VE.EndTime, vehicleType);
...
//                VE = vedNewDh2End,
//            };
//            LLNode newIdle2End = newDh2End.AddAfter(LLNodeType.Idle, new VEIdle(vedNewDh2End.Deadhead.DeadheadTemplate.To, vedNewDh2End.EndTime, t1Next.VE.StartTime, vehicleType));
//            newIdle2End.Next = t1Next;
//            // t2Prev -> t2Next
//            VEDeadhead vedNewDh2 = new(t2PrevTot2Next.Deadhead, t2Prev.VE.EndTime, vehicleType);
//            LLNode newDh2 = new()
//            {
//                NodeType = LLNodeType.Deadhead,
//                Prev = t2Prev,
...
//                VE = vedNewDh2,
//            };
//            LLNode newIdle2 = newDh2.AddAfter(LLNodeType.Idle, new VEIdle(vedNewDh2.Deadhead.DeadheadTemplate.To, vedNewDh2.EndTime, t2Next.VE.StartTime, vehicleType));
...
//            while (curr != null)
//            {
//                if (curr.NodeType == LLNodeType.Deadhead && ((VEDeadhead)curr.VE).Deadhead.ChargingActions.Count > 0)
//                {
...
//            VEDeadhead dh = (VEDeadhead)target.VE;
...
//            target.Next!.VE.StartTime = dh.EndTime;
